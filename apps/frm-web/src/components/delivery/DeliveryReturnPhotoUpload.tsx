/**
 * Delivery Return Photo Upload Component
 * Handles return evidence photo uploads with camera capture support
...
interface DeliveryReturnPhotoUploadProps {
...
export function DeliveryReturnPhotoUpload({
  photos,
  onPhotosChange,
  disabled = false,
  maxPhotos = 5,
}: DeliveryReturnPhotoUploadProps) {
